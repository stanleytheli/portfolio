      ...
      <div class="portfolio-sections">
        ...
        <section class="portfolio-section">
          ...
          <div class="section-content">
            ...
            <article class="experience">
              <div class="experience-header">
                <img src="/swoop_logo.jpg" alt="Company logo" class="experience-logo">
                <div class="experience-info">
        ...
        <section class="portfolio-section">
          ...
          <div class="section-content">
            <article class="project">
              ...
              <img src="/cubegpt_image.png" alt="Gravity Simulation screenshot" class="project-image">
            </article>
            ...
            <article class="project">
              ...
              <img src="/autoencoder_result.webp" alt="Project Two screenshot" class="project-image">
            </article>
